...
<Warning>
  You can alternatively copy the download URL from the download page
  from the websites, and paste it into the "**Download From URL**" button
  in the File Manager. This will download the JAR automatically and place
  it in the current working directory. Refer to [this guide](/panel/importing-files#download-files-from-url) for more information.
</Warning>

## Automatic update (Version Manager)
...
Feel free to contact us via [email](mailto:support@octant.sh), [Discord](https://discord.gg/compute),
or livechat if you need help or have any questions.