...
Before you can join and connect to your [Minecraft server](https://octant.sh/games/minecraft), you'll need to find the [IP](https://whatismyipaddress.com/ip-address) (a combination of numbers, e.g `127.0.0.1`) or a subdomain (letters, e.g `test.octant.sh`).

1. Head to the [Octant panel](https://my.octant.sh)
...
Running into issues? Join our [Discord community](https://discord.gg/compute) or contact us via [email](mailto:support@octant.sh) or livechat.