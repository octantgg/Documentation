...
1. Open the **Settings** tab on the [Octant Panel](https://my.octant.sh)
...
If you run into any issues or have questions, feel free to send us a message in our [community Discord server](https://discord.gg/compute) or contact us via [email](mailto:support@octant.sh) or livechat.