...
Resource packs, also known as texture packs (although they have their differences) can heavily modify how Minecraft looks in-game. You can customize sounds, textures, hotbars, inventories, and more — all enhancing and bringing uniqueness to your [Minecraft server](https://octant.gg/games/minecraft)!
...
{/* <Warning>MCPacks is not affiliated with Octant. Use at your own discretion.</Warning> */}
...
1. Login to the [Octant panel](https://my.octant.gg) and navigate to the file manager. Open the `server.properties` file and make the following changes:
...
# Using Dropbox
resource-pack=https://www.dropbox.com/s/<ID>/MyResourcePack.zip?dl=1
...
Once you've restarted the server, players who join in will now be prompted to use the custom resource pack! Click "**Yes**" and Minecraft will automatically download and load the resource pack for you.

If you have any questions or need help, join our [Discord community server](https://discord.gg/compute) or contact us via [email](mailto:support@octant.gg) or livechat.