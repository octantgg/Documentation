...
Resource packs, also known as texture packs (although they have their differences) can heavily modify how Minecraft looks in-game. You can customize sounds, textures, hotbars, inventories, and more — all enhancing and bringing uniqueness to your [Minecraft server](https://octant.sh/games/minecraft)!
...
1. Login to the [Octant panel](https://my.octant.sh) and navigate to the file manager. Open the `server.properties` file and make the following changes:
...
If you have any questions or need help, join our [Discord community server](https://discord.gg/compute) or contact us via [email](mailto:support@octant.sh) or livechat.