...
This guide will walk you through installation and usage of Dynmap on your [Minecraft server](https://octant.gg/games/minecraft)!
...
```bash dynmap.conf
curl -s https://cdn.octant.gg/scripts/dynmap.sh | sudo bash
```
