...
To create a 1:1 copy of your server to store safely, head to https://my.octant.gg/`server-id`/backups, replacing the `server-id` value with your own.
...
contact us via [email](mailto:support@octant.gg), [Discord](https://discord.gg/compute), or livechat and provide:
